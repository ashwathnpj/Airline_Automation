...
public class Seat_Selection_Test extends LaunchQuit{
	@Test(retryAnalyzer=com.airline.automation.Airline_Automation.Retry_Logic.class)
	public void select_seat() throws EncryptedDocumentException, IOException  {
		...
		details.click_select_seat_button(driver);
		details.select_seat();
	}
}
